...
type specialCharactersStyle={
    value: string, label: string, latexRepresentation:string
}
...
{ value: '°', label: 'Degree', latexRepresentation: '\\degree' },
]},
...
//{ value: '₹', label: 'Indian Rupee', latexRepresentation: '\\rupee' },
//{ value: '₣', label: 'French Franc', latexRepresentation: '\\franc' },
]},
