import { Combobox, Center, InputBase, Input, useCombobox, Tooltip } from "@mantine/core";
...
export default function SimpleCombobox({valueState, values, width, tooltip}:SimpleComboboxPropsType){
